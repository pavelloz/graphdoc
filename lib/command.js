...
var GraphQLDocumentGenerator = /** @class */ (function (_super) {
    ...
    GraphQLDocumentGenerator.prototype.action = function (input, out) {
        return __awaiter(this, void 0, void 0, function () {
            var output, projectPackageJSON_1, schema, plugins_1, partials_1, renderTypes, files, err_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, fs_2.createBuildDirectory(projectPackageJSON_1.graphdoc.output)];
                    case 5:
                        // Create Output directory
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, fs_2.writeFile(filePath, mustache_1.render(partials.index, templateData, partials, ['<%', '%>']) // erb syntax instead of liquid-like
                            )];
                }
            });
        });
